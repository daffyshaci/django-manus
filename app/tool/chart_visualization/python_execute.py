...
4. DO NOT use host OS paths like 'C:\\...'. Always use sandbox POSIX paths. Use '/workspace/...' or shorthand '/file.py' to refer to '/workspace/file.py'.
...
5. You can invoke this tool step-by-step to do data analysis from summary to in-depth with data report saved also""".format(
                    directory=config.sandbox.work_dir
                ),
            },
        },
        "required": ["code"],
